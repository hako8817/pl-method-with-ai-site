...
- 프롤로그: AI 시대 기획자는 개인지식관리(PKM)로 무엇을 어떻게 관리해야 하는가
- PART 1: 왜 기획자의 개인지식관리가 필요한가
- PART 2: 개인지식관리로 무엇을 관리해야 하는가
- PART 3: 개인지식관리로 어떻게 Capture 하는가
- PART 4: 개인지식관리로 어떻게 Organize 하는가
- PART 5: 개인지식관리로 어떻게 Distill 하는가
- PART 6: 개인지식관리로 어떻게 Express 하는가
- PART 7: 개인지식관리로 어떻게 운영하고 확장하는가
...
- Ch8. 개인지식관리의 입력으로서 Daily Capture를 설계하는 법
...
- Ch10. 객체와 분류 체계를 먼저 설계한다
  - Evidence Note
  - Decision Log
  - Knowledge Note
  - Project/Hub/Index

- Ch11. Knowledge Tree와 객체별 운영 규칙으로 구조를 고정한다
...
- Ch21. Knowledge와 Decision OS를 책에서 다루는 방식
